...
type SystemResource struct {
	...
	SqliteVersion NullableString `json:"sqliteVersion,omitempty"`
...
// GetSqliteVersion returns the SqliteVersion field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SystemResource) GetSqliteVersion() string {
	if o == nil || IsNil(o.SqliteVersion.Get()) {
		var ret string
		return ret
	}
	return *o.SqliteVersion.Get()
}
...
// SetSqliteVersion gets a reference to the given NullableString and assigns it to the SqliteVersion field.
func (o *SystemResource) SetSqliteVersion(v string) {
	o.SqliteVersion.Set(&v)
}
// SetSqliteVersionNil sets the value for SqliteVersion to be an explicit nil
func (o *SystemResource) SetSqliteVersionNil() {
	o.SqliteVersion.Set(nil)
}
...
func (o SystemResource) ToMap() (map[string]interface{}, error) {
	...
	if o.SqliteVersion.IsSet() {
		toSerialize["sqliteVersion"] = o.SqliteVersion.Get()
	}

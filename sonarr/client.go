...
// APIClient manages communication with the Sonarr API vv4.0.15.2941
...
type APIClient struct {
	...
	SeriesFolderAPI *SeriesFolderAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SeriesFolderAPI = (*SeriesFolderAPIService)(&c.common)

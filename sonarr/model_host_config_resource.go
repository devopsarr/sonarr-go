...
type HostConfigResource struct {
	...
	AllowedHosts NullableString `json:"allowedHosts,omitempty"`
	...
	TrustedNetworks NullableString `json:"trustedNetworks,omitempty"`
...
func (o *HostConfigResource) GetAllowedHosts() string {
	if o == nil || IsNil(o.AllowedHosts.Get()) {
		var ret string
		return ret
	}
	return *o.AllowedHosts.Get()
}
...
// SetAllowedHosts gets a reference to the given NullableString and assigns it to the AllowedHosts field.
func (o *HostConfigResource) SetAllowedHosts(v string) {
	o.AllowedHosts.Set(&v)
}
// SetAllowedHostsNil sets the value for AllowedHosts to be an explicit nil
func (o *HostConfigResource) SetAllowedHostsNil() {
	o.AllowedHosts.Set(nil)
}
...
// GetTrustedNetworks returns the TrustedNetworks field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *HostConfigResource) GetTrustedNetworks() string {
	if o == nil || IsNil(o.TrustedNetworks.Get()) {
		var ret string
		return ret
	}
	return *o.TrustedNetworks.Get()
}

// GetTrustedNetworksOk returns a tuple with the TrustedNetworks field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetTrustedNetworks gets a reference to the given NullableString and assigns it to the TrustedNetworks field.
func (o *HostConfigResource) SetTrustedNetworks(v string) {
	o.TrustedNetworks.Set(&v)
}
// SetTrustedNetworksNil sets the value for TrustedNetworks to be an explicit nil
func (o *HostConfigResource) SetTrustedNetworksNil() {
	o.TrustedNetworks.Set(nil)
}
...
func (o HostConfigResource) ToMap() (map[string]interface{}, error) {
	...
	if o.AllowedHosts.IsSet() {
		toSerialize["allowedHosts"] = o.AllowedHosts.Get()
	}
	...
	if o.TrustedNetworks.IsSet() {
		toSerialize["trustedNetworks"] = o.TrustedNetworks.Get()
	}

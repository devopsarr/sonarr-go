...
type ApiDeleteImportListExclusionBulkRequest struct {
	ctx context.Context
	ApiService *ImportListExclusionAPIService
	importListExclusionBulkResource *ImportListExclusionBulkResource
}

func (r ApiDeleteImportListExclusionBulkRequest) ImportListExclusionBulkResource(importListExclusionBulkResource ImportListExclusionBulkResource) ApiDeleteImportListExclusionBulkRequest {
	r.importListExclusionBulkResource = &importListExclusionBulkResource
	return r
}

func (r ApiDeleteImportListExclusionBulkRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteImportListExclusionBulkExecute(r)
}

/*
DeleteImportListExclusionBulk Method for DeleteImportListExclusionBulk

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeleteImportListExclusionBulkRequest
*/
func (a *ImportListExclusionAPIService) DeleteImportListExclusionBulk(ctx context.Context) ApiDeleteImportListExclusionBulkRequest {
	return ApiDeleteImportListExclusionBulkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ImportListExclusionAPIService) DeleteImportListExclusionBulkExecute(r ApiDeleteImportListExclusionBulkRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImportListExclusionAPIService.DeleteImportListExclusionBulk")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/importlistexclusion/bulk"
...
type ApiGetImportListExclusionPagedRequest struct {
	ctx context.Context
	ApiService *ImportListExclusionAPIService
	page *int32
	pageSize *int32
...
func (r ApiGetImportListExclusionPagedRequest) Page(page int32) ApiGetImportListExclusionPagedRequest {
	r.page = &page
	return r
}

func (r ApiGetImportListExclusionPagedRequest) PageSize(pageSize int32) ApiGetImportListExclusionPagedRequest {
	r.pageSize = &pageSize
	return r
}

func (r ApiGetImportListExclusionPagedRequest) SortKey(sortKey string) ApiGetImportListExclusionPagedRequest {
	r.sortKey = &sortKey
	return r
}

func (r ApiGetImportListExclusionPagedRequest) SortDirection(sortDirection SortDirection) ApiGetImportListExclusionPagedRequest {
	r.sortDirection = &sortDirection
	return r
}

func (r ApiGetImportListExclusionPagedRequest) Execute() (*ImportListExclusionResourcePagingResource, *http.Response, error) {
	return r.ApiService.GetImportListExclusionPagedExecute(r)
}

/*
GetImportListExclusionPaged Method for GetImportListExclusionPaged

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetImportListExclusionPagedRequest
*/
func (a *ImportListExclusionAPIService) GetImportListExclusionPaged(ctx context.Context) ApiGetImportListExclusionPagedRequest {
	return ApiGetImportListExclusionPagedRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ImportListExclusionAPIService) GetImportListExclusionPagedExecute(r ApiGetImportListExclusionPagedRequest) (*ImportListExclusionResourcePagingResource, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImportListExclusionAPIService.GetImportListExclusionPaged")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v3/importlistexclusion/paged"
